<template>
  <div
    data-test="campaigns-info-brand-awareness-ppva"
  ...
  >
    ...
    <!-- Price per views  -->
    <div class="campaigns-sidebar-info__item">
      <div class="_text-s-regular mb-1 text-gray">
      ...
      <div
        ...
        class="_text-m-regular"
      >
        {{ formatPayout(adset.creatorPayout.price) }}
      </div>
    </div>
    ...
    <div v-if="props.adset.dailyActionLimit.enabled">
      <div class="_text-s-regular mb-1 text-gray">
        {{ t('campaignSidebar.pricePerAction') }}
      </div>
      <div
        data-test="campaigns-info-price-per-action"
        class="_text-m-regular"
      >
        {{ formatPayout(adset.dailyActionLimit.actionPrice) }}
      </div>
    </div>
    <!-- End of Price per action -->
