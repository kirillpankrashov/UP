<template>
  <div
    data-name="campaigns-info-brand-awareness-cpa"
  ...
  >
    ...
    <!-- EVR -->
    <!-- <div
        v-if="props.campaign?.strategy_payment?.slug === 'cpa'"
        class="campaigns-sidebar-info__item _full"
      >
...
// const evrList = computed(() => {
//   return props.campaign?.evr.map(item => {
//     let txt = item.title
