<template>
  <div
    data-name="campaigns-info-creativebrand-awareness"
  ...
  >
    ...
    >
      ...
      <CopyLink
        v-if="![StrategyPayment.CPC].includes(adset.strategyPayment.slug)"
        class="mt-4"
        :link="copyProductLink"
...
import { CopyLink, Preview } from '@/components'
...
const copyProductLink = async () => {
	const res = await campaignStore.fetchBrandAwarenessProductLink(slide.value.slug)
