<template>
  <div
    data-name="campaigns-info-creative-extension"
  ...
  >
    ...
    <div class="relative">
      <PreviewExtensionBanner
        v-if="adset.format.id === AdFormat.EXT_BANNER && slide.attachments.panel"
        :panel="slide.attachments.panel"
      />

      <PreviewQuiz
        v-if="adset.format.id === AdFormat.EXT_QUIZ && slide.attachments.quiz"
        :quiz="slide.attachments.quiz"
      />

      <PreviewExtensionGallery
        v-if="adset.format.id === AdFormat.EXT_GALLERY && slide.attachments.gallery"
        :gallery="slide.attachments.gallery"
      />
