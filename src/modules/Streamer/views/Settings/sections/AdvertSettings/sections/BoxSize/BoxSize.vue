<template>
  <div
    v-if="widget"
    id="settings-box-size"
    class="mb-3"
  >
    <div class="mb-4 flex justify-between">
      <div class="_text-s-regular text-dark-gray">
        {{ t('settings.advertSettings.adsBlocksCountTitle') }}
      </div>
      <div class="_text-s-regular text-dark-gray">
        {{ t('settings.advertSettings.adsBlocksCountDuration', { seconds: widget.boxSize * 15 }) }}
      </div>
    </div>
