  ...
  >
    ...
    <div class="_text-m-regular mb-4 flex items-center">
      ...
      <ElTag
        ...
        effect="dark"
        round
        :type="widget.extensionEnabled ? 'success' : 'danger'"
      >
        {{ widget.extensionEnabled ? t('settings.header.enabled') : t('settings.header.disabled') }}
      </ElTag>
    </div>

    <div
      v-if="!widget.extensionEnabled"
    ...
    >
      ...
      <ReloadButton
        ...
        @click="settingsStore.checkExtension"
        :loading="settingsStore.checkingExtension"
      >
