...
export const performanceAdset: IPerformanceAdset = {
	...
	format: {
		...
		'description': 'Multiformat creative in the visible area of the Twitch video player.',
	...
	'slug': 'PF-GRP-1740841438',
	'title': { default: 'VK Видео // Pop-up Albion Online // Февраль 2025' },
	'description': '',
	dates: {
		'start': '19.02.2025',
		'end': '19.03.2025',
