<template>
  <div
    data-name="partner-campaigns-adsets-sidebar-skeleton"
    data-test="partner-campaigns-adsets-sidebar-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='partner-campaigns-adsets-sidebar-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
</style>
