<template>
  <div
    data-name="campaigns-performance-adsets-skeleton"
    data-test="campaigns-performance-adsets-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-performance-adsets-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-performance-adsets-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
