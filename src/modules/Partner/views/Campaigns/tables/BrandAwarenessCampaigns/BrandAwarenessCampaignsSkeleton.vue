<template>
  <div
    data-name="campaigns-brand-awareness-campaigns-skeleton"
    data-test="campaigns-brand-awareness-campaigns-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-brand-awareness-campaigns-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-brand-awareness-campaigns-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
