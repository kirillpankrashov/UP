<template>
  <div
    data-name="campaigns-preroll-campaigns-skeleton"
    data-test="campaigns-preroll-campaigns-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-preroll-campaigns-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-preroll-campaigns-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
