<template>
  <div
    data-name="campaigns-extension-campaigns-skeleton"
    data-test="campaigns-extension-campaigns-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-extension-campaigns-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-extension-campaigns-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
