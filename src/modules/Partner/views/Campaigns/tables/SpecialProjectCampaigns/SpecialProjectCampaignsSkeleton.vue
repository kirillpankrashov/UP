<template>
  <div
    data-name="campaigns-special-project-campaigns-skeleton"
    data-test="campaigns-special-project-campaigns-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-special-project-campaigns-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-special-project-campaigns-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
