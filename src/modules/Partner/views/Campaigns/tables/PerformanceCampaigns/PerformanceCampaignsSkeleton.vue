<template>
  <div
    data-name="campaigns-performance-campaigns-skeleton"
    data-test="campaigns-performance-campaigns-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
    >
      <template #template>
        ...
        >
          ...
          <ElTableColumn
            v-if="columns.state"
            :label="t('campaigns.tables.columns.state')"
            width="100"
          >
            <template #default>
              <ElSkeletonItem
          ...
          <ElTableColumn
            ...
            :label="t('campaigns.tables.columns.moderation')"
            width="120"
          >
            <template #default>
              <ElSkeletonItem
...
const skeletonRows = Array.from({ length: 10 }).map((_, idx) => ({ id: idx + 1 }))
</script>

<style scoped lang="scss">
[data-test='campaigns-performance-campaigns-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-performance-campaigns-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
