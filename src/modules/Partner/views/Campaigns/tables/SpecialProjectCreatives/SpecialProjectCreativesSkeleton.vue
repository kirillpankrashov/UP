<template>
  <div
    data-name="campaigns-special-project-creatives-skeleton"
    data-test="campaigns-special-project-creatives-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-special-project-creatives-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-special-project-creatives-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
