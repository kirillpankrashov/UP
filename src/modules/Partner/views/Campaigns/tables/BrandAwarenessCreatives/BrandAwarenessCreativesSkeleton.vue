<template>
  <div
    data-name="campaigns-brand-awareness-creatives-skeleton"
    data-test="campaigns-brand-awareness-creatives-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-brand-awareness-creatives-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-brand-awareness-creatives-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
