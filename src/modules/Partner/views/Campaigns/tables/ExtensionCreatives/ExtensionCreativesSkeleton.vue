<template>
  <div
    data-name="campaigns-extension-creatives-skeleton"
    data-test="campaigns-extension-creatives-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-extension-creatives-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-extension-creatives-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
