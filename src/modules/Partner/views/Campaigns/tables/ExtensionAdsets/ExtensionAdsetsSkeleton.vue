<template>
  <div
    data-name="campaigns-extension-adsets-skeleton"
    data-test="campaigns-extension-adsets-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
...
[data-test='campaigns-extension-adsets-skeleton'] :deep(.el-table .cell) {
  text-overflow: clip;
}
[data-test='campaigns-extension-adsets-skeleton'] :deep(.el-table__cell) {
  height: 48px;
}
</style>
