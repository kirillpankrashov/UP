...
import { type ISpecialProjectCampaignStructure } from '../types'

export const specialProjectCampaignStructure: ISpecialProjectCampaignStructure = {
	id: 331,
	slug: 'SP-CMP-1740612001',
