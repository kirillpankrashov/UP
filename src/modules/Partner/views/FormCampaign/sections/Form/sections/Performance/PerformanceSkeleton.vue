<template>
  <div
    data-name="partner-form-campaign-performance-skeleton"
    data-test="partner-form-campaign-performance-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
    >
      <template #template>
        ...
        >
          ...
          <!-- 3. FormDescription (markdown editor) -->
          <div class="!mb-6">
            <ElSkeletonItem
              variant="text"
              class="mb-2 !h-[14px]"
