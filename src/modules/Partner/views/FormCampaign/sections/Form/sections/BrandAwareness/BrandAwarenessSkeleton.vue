<template>
  <div
    data-name="partner-form-campaign-brand-awareness-skeleton"
    data-test="partner-form-campaign-brand-awareness-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
    >
      <template #template>
        ...
        >
          ...
          <!-- 2. FormDescription (markdown editor) -->
          <div class="!mb-6">
            <ElSkeletonItem
              variant="text"
              class="mb-2 !h-[14px]"
