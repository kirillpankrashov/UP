<template>
  <div
    data-name="partner-form-adset-extension-skeleton"
    data-test="partner-form-adset-extension-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
    >
      <template #template>
        ...
        >
          ...
          <!-- FormTitle: default + alternative name -->
          <div class="mb-6">
            <ElSkeletonItem
              variant="text"
              class="mb-2 !h-[14px]"
          ...
          <!-- FormBudget: strategy + PPV grid (bid / impressions) + total -->
          <div class="mb-6">
            <ElSkeletonItem
              variant="text"
              class="mb-2 !h-[14px]"
          ...
          <!-- Goals: DashboardSubsection + one benchmark (CTR for PPV/PPVA, EVR for CPA) -->
          <div>
            <ElSkeletonItem
              variant="text"
              class="mb-3 !h-4"
