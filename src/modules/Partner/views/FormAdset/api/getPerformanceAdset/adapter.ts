...
export const responseToData = (response: IPerformanceAdsetResponse): IPerformanceAdset => {
	return {
		id: response.id,
		format: {
		...
		campaign: {
			...
			externalId: response.campaign.external_id,
		...
		productUrlShort: response.product_url_short,
