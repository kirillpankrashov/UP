<template>
  <div data-name="partner-form-adset-title">
    <ElFormItem
      :label="t('adset.settings.form.name.label')"
      prop="title.default"
    >
      <ElInput
        :placeholder="t('adset.settings.form.name.placeholder')"
        size="large"
    ...
    >
      ...
      {{ t('adset.settings.form.altName.addBtn') }}
    </button>
    ...
    >
      <ElFormItem
        :label="t('adset.settings.form.altName.label')"
