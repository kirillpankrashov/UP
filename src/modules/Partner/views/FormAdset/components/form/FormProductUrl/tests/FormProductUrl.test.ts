...
describe('FormAdset FormProductUrl', () => {
	...
	it('passes correct props to general input', () => {
		...
		expect(input.props().placeholder).toBe('adset.chatBot.form.productUrl.placeholder')
	...
	it('passes correct props to mobile input', () => {
		...
		expect(input.props().placeholder).toBe('adset.chatBot.form.mobileProductUrl.placeholder')
		expect(input.props().size).toBe('large')
