...
import type {
	...
	ICreateExtensionCreativePayload,
} from './types'

export const dataToPayload = (data: ICreateExtensionCreativeData): ICreateExtensionCreativePayload => {
	...
	return {
		...
		quiz: data.quiz ? quizDataToPayload(data.quiz) : undefined,
		panel: data.panel,
