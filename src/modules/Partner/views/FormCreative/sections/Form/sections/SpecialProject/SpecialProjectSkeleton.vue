<template>
  <div
    data-name="partner-form-creative-special-project-skeleton"
    data-test="partner-form-creative-special-project-skeleton"
  >
    <ElSkeleton
      animated
      :loading="true"
    >
      <template #template>
        ...
        <DashboardSection :title="t('creative.form.files.title')">
          <div class="file-uploader w-full">
            <div class="flex w-full items-center rounded bg-primary-50 p-5">
              <ElSkeletonItem
                variant="text"
                class="mr-4 !h-9 !w-9 shrink-0 rounded"
              />
              <div class="flex min-w-0 flex-1 flex-col gap-2">
                <ElSkeletonItem
                  variant="text"
                  class="!h-[14px] max-w-full"
